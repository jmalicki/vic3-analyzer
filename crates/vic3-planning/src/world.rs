...
/// for discrete floats that are part of identity. **`good_prices`, `gdp`, and
/// `warm_relative` are omitted** from Hash/Eq by default (derived solve outputs);
...
mod tests {
    ...
    fn from_save_with_prices_models_gdp_from_owned_building_revenue() {
        ...
        let building = |id, state_id, revenue| BuildingEconomics {
            ...
            building_type_label: String::new(),
            level: 1.0,
            staffing: 1.0,
